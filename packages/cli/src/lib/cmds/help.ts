...
import {Log, ConsoleLog} from '@pwawrap/core';
...
const HELP_MESSAGES = new Map<string, string>(
    [
      ['main', [
        'pwawrap [command] <options>',
        '',
        '',
        'build ............... generates an Android APK from a TWA Project',
        'help ................ shows this menu',
        'init ................ initializes a new TWA Project',
        'update .............. updates an existing TWA Project with the latest pwawrap template',
      ...
      ['init', [
        ...
        '',
        '',
        'pwawrap init --manifest=[web-manifest-url]',
        '',
        '',
        'Options:',
